...
//jml booking
$qyuk = mysqli_query($koneksi, "SELECT * FROM orderan");
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">BOOKING SEMUA</span>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">BOOKING BELUM VERIFIKASI</span>
              <span class="info-box-number"><?php echo $jml_booking;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">BOOKING SUDAH MASUK</span>
              <span class="info-box-number"><?php echo $jml_booking;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">BOOKING EXPIRE</span>
              <span class="info-box-number"><?php echo $jml_booking;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
